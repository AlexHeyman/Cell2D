...
import celick.Input;
import celick.util.InputAdapter;
...
public class InputProvider {
	...
	private class InputListenerImpl extends InputAdapter {
		/**
		 * @see celick.util.InputAdapter#isAcceptingInput()
		 */
		...
		/**
		 * @see celick.util.InputAdapter#keyPressed(int, char)
		 */
		...
		/**
		 * @see celick.util.InputAdapter#keyReleased(int, char)
		 */
		...
		/**
		 * @see celick.util.InputAdapter#mousePressed(int, int, int)
		 */
		...
		/**
		 * @see celick.util.InputAdapter#mouseReleased(int, int, int)
		 */
		...
		/**
		 * @see celick.util.InputAdapter#controllerLeftPressed(int)
		 */
		...
		/**
		 * @see celick.util.InputAdapter#controllerLeftReleased(int)
		 */
		...
		/**
		 * @see celick.util.InputAdapter#controllerRightPressed(int)
		 */
		...
		/**
		 * @see celick.util.InputAdapter#controllerRightReleased(int)
		 */
		...
		/**
		 * @see celick.util.InputAdapter#controllerUpPressed(int)
		 */
		...
		/**
		 * @see celick.util.InputAdapter#controllerUpReleased(int)
		 */
		...
		/**
		 * @see celick.util.InputAdapter#controllerDownPressed(int)
		 */
		...
		/**
		 * @see celick.util.InputAdapter#controllerDownReleased(int)
		 */
		...
		/**
		 * @see celick.util.InputAdapter#controllerButtonPressed(int,
		 *      int)
		 */
		...
		/**
		 * @see celick.util.InputAdapter#controllerButtonReleased(int,
		 *      int)
		 */
