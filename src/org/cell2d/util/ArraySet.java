 ...
 * better performance when the Set size is very small. For best results, the
 * initial capacity of an ArraySet should be set to the smallest number that the
 * ArraySet's size will almost certainly never exceed.
